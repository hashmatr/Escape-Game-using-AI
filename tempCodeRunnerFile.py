...
player_speed = 1# Adjust this value as needed for desired speed
...
def display_game_summary():
    ...
    text = font.render(f"Total AI Actions: {total_actions}", True, (255, 255, 255))
    ...
    for action, count in action_counts.items():
        text = font.render(f"{action}: {count} times", True, (255, 255, 255))
        screen.blit(text, (50, y_pos))
        y_pos += 30
